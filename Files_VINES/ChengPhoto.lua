...
local VINESFileChengPhoto = database:get(bot_id.."VINESFile:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if VINESFileChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."VINESFile:Cheng:Photo"..data.id_) 
end
end
...
database:set(bot_id.."VINESFile:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
